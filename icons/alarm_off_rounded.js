...
Icon.register({
  alarm_off_rounded: {
    paths: [
      ...
      {
        d: 'M19.91 6.56c.42.35 1.03.29 1.38-.12l.03-.03a.981.981 0 0 0-.12-1.38l-3.1-2.59a.981.981 0 0 0-1.38.12l-.03.03a.981.981 0 0 0 .12 1.38l3.1 2.59zM7.43 3.68c.18-.34.15-.77-.11-1.09l-.03-.03c-.3-.36-.8-.43-1.2-.22l1.34 1.34z'
      }
    ],
    width: '24',
    height: '24'
